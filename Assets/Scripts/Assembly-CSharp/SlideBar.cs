...
public class SlideBar : MonoBehaviour
{
	...
	public void Update()
	{
		...
		{
			Vector2 dragPosition = DestroyableSingleton<PassiveButtonManager>.Instance.Controller.DragPosition;
			Vector2 vector = dragPosition - (Vector2)Bar.transform.position;
			if (Vertical)
			{
