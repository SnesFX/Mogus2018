...
public class TuneRadioMinigame : Minigame
{
	...
	public override void Begin(PlayerTask task)
	{
		...
		{
			SoundManager.Instance.PlayDynamicSound("CommsRadio", RadioSound, true, GetRadioVolume, true);
			SoundManager.Instance.PlayDynamicSound("RadioStatic", StaticSound, true, GetStaticVolume, true);
		}
	}
