...
public class AlignGame : Minigame
{
	...
	public override void Begin(PlayerTask task)
	{
		...
		centerline.material.SetColor("_Color", (!flag) ? Color.red : Color.green);
		engine.color = ((!flag) ? Color.red : Color.green);
	...
	public void Update()
	{
		...
		case DragState.Dragging:
		{
			...
			centerline.material.SetColor("_Color", (!flag2) ? Color.red : Color.green);
